...
- **Enhanced Context Menu**: Rich webview context menu with open link in new tab, reload, save as, copy, paste, diagnostics, and settings options.
...
- **Built-in Password Manager**: Secure password storage with encrypted local storage, autofill functionality, password generation, and strength analysis.
...
- `Ctrl+Shift+G`: Open password generator
